...
0. "회원"은 본회에 소속된 사람을 말하며, 활동회원, 비활동회원, 졸업회원을 포함한다.
0. "활동회원"은 해당 학기에 본회의 정규 활동에 참여하는 회원으로서 제6조의 최소활동기준을 충족하여야 할 의무를 가지며, 본 회칙에서 정한 의결권을 가진다.
0. "신입회원"은 해당 학기에 본회에 최초로 가입하여 회원 자격을 부여받은 사람을 말한다. 신입회원은 해당 학기 동안 활동회원으로 보며, 비활동회원 또는 졸업회원으로 전환할 수 없다.
0. "비활동회원"은 제6조 제5항에 따라 최소활동기준을 면제받아 회원자격을 유지하는 회원을 말하며, 해당 학기 활동회원으로 보지 아니하고 의결권을 가지지 아니한다.
0. "졸업회원"은 본회에 회원으로서 활동하다가 졸업 또는 이에 준하는 사유로 정규 활동의 의무가 종료된 회원을 말한다. 졸업회원은 본회 소속을 유지한다.
0. "동아리방"은 본회가 학교로부터 제공받는 자치공간을 말한다.
0. "특별관리자"는 본회의 필요에 따라 본회의 특별한 임무를 전담하는 회원을 말한다.
0. "부서"는 본회의 운영을 위해 회원으로 조직된 내부 단체를 말한다.
0. "회장단"은 회칙에 의해 조직된 본회의 주요직위자들의 단체를 말하며, 회칙 내에서 임원진으로 지칭되는 구성원들을 포함한다.
...
0. 활동 참여권
    ...
    0. 다만, 비활동회원 및 졸업회원의 활동 참여 범위는 회장단이 정하는 바에 따른다. 이 경우 세미나, 스터디 및 기타 학술활동에의 수강 또는 참석은 해당 학기 회비를 납부한 경우에 한하여 허용한다.
0. 의사결정권
    0. 회원은 총회에 참여할 권리를 가진다.
    0. 활동회원은 총회의 표결에 참여할 권리를 가진다.
0. 절차권
...
0. 활동회원은 매 학기 최소 10시간 이상의 최소활동기준 시간을 충족하여야 한다.
0. 최소활동기준 시간은 다음 각 호의 활동을 통해 인정된다.
    0. 세미나 또는 스터디 참여.
    0. 개강총회, 종강총회, 소모임, MT 등 본회가 인정하는 공식 행사 참여 (단, 본 호에 따른 인정 시간은 학기당 최대 5시간으로 제한한다.)
    0. 각 부서에서 인정하는 프로젝트를 진행하거나 참가한 경우 (프로젝트 1회당 10시간을 인정한다.)
0. 다음 각 호 중 어느 하나에 해당하는 경우에는 제1항의 최소활동기준을 충족한 것으로 본다.
    0. 세미나 또는 스터디를 4시간 이상 주최한 경우.
    0. 최소활동기준 시간을 5시간 이상 보유하고 있으며, 세미나 또는 스터디를 2시간 이상 주최한 경우.
    0. 동아리에 기술적으로 기여한 경우.
    0. 해당 학기에 임원진으로 활동한 경우.
0. 세미나에 참여하는 모든 회원은 수강하는 세미나/스터디에 지각 또는 결석할 경우, 해당 활동 인정 시간에서 차감하는 등 불이익을 받는다.
    0. 2회의 지각은 1회의 결석으로 처리되고, 1회의 결석은 해당 회원의 세미나와 스터디 참여시간에서 1시간 삭감한다.
    0. 2회의 결석 시 해당 회원의 세미나/스터디 참여시간에서 2시간 삭감하며, 경고를 준다.
    0. 3회의 결석 시 임원진은 회의를 거쳐 해당 회원을 제명하거나 그에 상응하는 수준의 불이익을 줄 수 있다.
0. 아래의 각 호중 적어도 한 가지 경우에 해당하는 사유에 대하여 회장단의 사전 또는 사후 승인을 받은 회원은 제1항을 만족하지 아니하여도 회원자격을 유지한다. 이 경우 해당 회원은 그 기간 동안 비활동회원으로 본다.
    0. 허가된 기간(군 휴학의 경우 군 복무 기간, 일반 휴학의 경우 활동하지 않은 시점부터 연속 2학기)내에 휴학 중이거나 수료 후 졸업 보류중인 경우.
    0. 기타 학업에 대한 어려움을 인정할 사유가 있는 경우(학기 중 본인이나 가족이 위중한 질병을 앓고 있는 경우, 학기 중 가족의 상을 치룬 경우 등).
    0. 졸업직전 학기를 수강중이거나 회사, 연구실 인턴을 하는 경우 (졸업직전 학기 사유는 재학 중 1회로 제한한다.).
    0. 해당 학기에 임원진으로 활동하는 경우.
0. 제5항에 따른 회원자격 유지는 연속 3개 학기를 초과하여 적용할 수 없다. 단, 군 복무로 인한 휴학 및 제5항 제2호에 해당하는 경우는 본 제한에 포함하지 아니한다.
0. 제5항 제1호 및 제3호의 경우에는 관련 사실을 증명할 수 있는 공식 서류를 제출하여야 하며, 개인의 사유가 제5항 제2호에 해당하는지는 회장단 회의를 통해 결정한다. 모든 증빙 및 심의 절차는 해당 학기 종강 전까지 완료하여야 한다.
0. 제5항의 규정은 해당 학기에 최초로 가입한 신입회원에게는 적용하지 아니한다.
0. 학술부장은 제2항 및 제3항에 따른 활동의 인정 여부를 판단할 권한을 가진다.
0. 게임제작부장은 제2항에 따른 활동의 인정 여부를 판단할 권한을 가지며, 제3항 제3호의 기술적 기여에 대한 판단에 참여할 권한을 갖는다.
0. 회장, 부회장은 제1항부터 제4항까지의 충족 여부를 최종 확인할 권한을 가진다.
0. 최소활동기준을 판단하는 데 있어서 학기의 시작은 봄학기, 가을학기에 대해 각각 학교 학사일정에 따른 개강일로 정하고, 학기의 끝은 각각 다음 학기 개강 전 날로 한다.
0. 회장은 학기 말에 학술부장 및 게임제작부장과 협의하여 활동회원의 최소활동기준 충족 여부를 확인한다. 최소활동기준을 충족하지 못한 활동회원은 탈퇴 처리한다.
...
1. 게임제작부장은 프로젝트 등록을 상시 받아야하는 의무를 지닌다
	1. 프로젝트의 등록은 동아리 부원만 가능하며, 그 외의 상황은 임원진 회의에서 심사한다
	2. 등록한 프로젝트만이 풀씨 이름 하에 대회를 참가할 수 있는 권리를 가진다.
	3. 등록한 프로젝트만이 풀씨의 공용 에셋을 사용할 수 있는 권리를 가진다
	4. 등록한 프로젝트만이 특정 대회에 한해 대회 당 전시비용 최대 4만원(프로젝트 당 한 학기 최대 12만원)을 지원받을 수 있는 권리를 가진다. 다만 지원 가능 대회 명단은 임원진 회의 후 결정되며, 해당 대회를 홍보 시 지원 가능 대회임을 명시할 예정
	5. 등록한 프로젝트가 상업 출시를 하는 경우, 풀씨 로고나 풀씨로부터 지원받았다는 글귀를 게임 크레딧에 넣어야 하는 의무를 가진다
	6. 상업출시를 한 프로젝트가 제5호를 지키지 않을 시 제4호에 의거해 지급된 전시비용을 전액 반환해야 한다.

#### 제 15조 (웹앱부)

0. 웹앱부는 본회에 대한 서비스개발사의 대학생 동아리 지원사업에 참여를 담당하는 부서이다.
0. 웹앱부장은 구성원을 임명할 권리를 가진다.
0. 웹앱부장은 구성원을 적절하게 조직하여 내부의 팀을 만들 권리를 가진다.
0. 웹앱부장은 구성원이 활동에 성실하게 참여했는지 판단할 권리를 가진다.
0. 웹앱부장은 서비스개발사의 대학생 동아리 지원사업에 성실하게 참여할 의무를 가진다.
1. 웹앱부장은 프로젝트 등록을 상시 받아야하는 의무를 지닌다
	1. 프로젝트의 등록은 동아리 부원만 가능하며, 그 외의 상황은 임원진 회의에서 심사한다
	2. 등록한 프로젝트만이 풀씨 이름 하에 대회를 참가할 수 있는 권리를 가진다.
	3. 등록한 프로젝트만이 풀씨의 공용 에셋을 사용할 수 있는 권리를 가진다
	4. 등록한 프로젝트만이 특정 대회에 한해 대회 당 전시비용 최대 4만원(프로젝트 당 한 학기 최대 12만원)을 지원받을 수 있는 권리를 가진다. 다만 지원 가능 대회 명단은 임원진 회의 후 결정되며, 해당 대회를 홍보 시 지원 가능 대회임을 명시할 예정
	5. 등록한 프로젝트가 상업 출시를 하는 경우, 풀씨 로고나 풀씨로부터 지원받았다는 글귀를 서비스에 넣어야 하는 의무를 가진다
	6. 상업출시를 한 프로젝트가 제5호를 지키지 않을 시 제4호에 의거해 지급된 전시비용을 전액 반환해야 한다.

#### 제 16조 (AI부)

0. AI부는 본회에 대한 서비스개발사의 대학생 동아리 지원사업에 참여하거나 AI 와 관련된 연구 프로젝트를 담당하는 부서이다.
0. AI부장은 구성원을 임명할 권리를 가진다.
0. AI부장은 구성원을 적절하게 조직하여 내부의 팀을 만들 권리를 가진다.
0. AI부장은 구성원이 활동에 성실하게 참여했는지 판단할 권리를 가진다.
0. AI부장은 서비스개발사의 대학생 동아리 지원사업에 성실하게 참여할 의무를 가진다.
1. AI부장은 프로젝트 등록을 상시 받아야하는 의무를 지닌다
 	1. 프로젝트의 등록은 동아리 부원만 가능하며, 그 외의 상황은 임원진 회의에서 심사한다
	2. 등록한 프로젝트만이 풀씨 이름 하에 대회를 참가할 수 있는 권리를 가진다.
	3. 등록한 프로젝트만이 풀씨의 공용 에셋을 사용할 수 있는 권리를 가진다
	4. 등록한 프로젝트만이 특정 대회에 한해 대회 당 전시비용 최대 4만원(프로젝트 당 한 학기 최대 12만원)을 지원받을 수 있는 권리를 가진다. 다만 지원 가능 대회 명단은 임원진 회의 후 결정되며, 해당 대회를 홍보 시 지원 가능 대회임을 명시할 예정
...
0. 탄핵의 경우에는 18조1항의 총회의 의장을 '회장'에서 '탄핵 위원회장'으로 적용한다.
...
1. 총회가 열린 시점에서 졸업회원을 제외한 회원 정원의 1/3 이상이 참석하지 않았을 경우, 최소 20명이 참석했을 때만 그 자리에 있는 인원의 2/3 이상이 동의할 시 해당 총회에서 가결된 안건은 회칙에 반영된다
...
1. 회원이 정기총회 참여의무를 면제받지 않았음에도 불참할 경우에는 결석으로 처리하며, 회장이 해당 회원의 해당학기 최소활동기준을 가중 적용시켜야 한다.
	1. 정기총회 중 한 번을 결석 시 활동시간을 2시간 삭감한다.
	2. 정기 총회 두 번을 전부 결석 시 임원진은 회의를 거쳐 해당 인원을 제명하거나 상응하는 수준의 불이익을 줄 수 있다.
...
0. 징계위원회는 어떤 회원이라도 제27조에 해당하는 행위를 한 경우 그를 대상으로 하여 어떤 회원이라도 회장에게 요청할 수 있고 회장 혹은 부회장이 발의하여 소집한다.
0. 징계위원회 소집 요청에 대해 징계대상자가 제27조에 해당하는 행위를 하지 않은 것이 명백할 때에는 회장 혹은 부회장은 이를 기각할 수 있다.
...
0. 배심원단은 징계위원장, 징계대상자와 변호인의 의견을 검토하여 징계 여부와 제28조에 의거하여 징계의 종류와 수위를 결정한다.
0. 징계위원장, 징계대상자와 변호인은 징계 결과에 대해 이의 제기를 1회 할 수 있다.
0. 이의제기가 있을 경우 제23조 제4항에 따라 배심원단을 다시 선발하여 새로운 배심원단이 판단하도록 한다.

#### 제25조 (징계위원장 및 배심원단의 결격사유)
...
0. 회장단은 졸업회원이 제27조에 해당하는 행위를 한 경우 그를 회장단령을 통해 징계할 수 있다.
0. 졸업회원에 대한 징계의 종류는 제28조 제1항에 한한다.
