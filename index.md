...
1. 회원은 매 학기 다음의 각 호에 해당하는 활동을 적어도 한 가지 이상 완수해야 한다
	1. 세미나 혹은 스터디를 10시간 이상 수강하거나, 세미나 혹은 스터디를 4시간 이상 개최하는 동시에 한학기동안 공부한 내용을 담은 글을 활동하는 학기에 1개 이상 소속 부서(팀) 부장(팀장)에게 전달
	2. 세미나 혹은 스터디를 5시간 이상 수강하거나, 세미나 혹은 스터디를 2시간 이상 개최하는 동시에 본인이 속한 부서(팀)로 들어오는 작업에 프리랜서로 참여
	3. 세미나 혹은 스터디를 5시간 이상 수강하거나, 세미나 혹은 스터디를 2시간 이상 개최하는 동시에 활동하는 학기 말까지 개괄 기획서 1종류, 세부 시스템 기획서 3종류를 포함한 게임 기획안 제출
	4. 세미나 혹은 스터디를 5시간 이상 수강하거나, 세미나 혹은 스터디를 2시간 이상 개최하는 동시에 풀씨 공용 에셋 제작
	5. 미등록 프로젝트를 진행하거나 미등록 프로젝트에 참가하여, 활동하는 학기 말에 진행상황에 대한 보고서 제출
	6. 프로젝트를 등록하여 진행하거나 등록된 프로젝트에 참가하여, 활동하는 학기 말에 진행상황에 대한 보고서 제출
	7. 프로그래밍 활동이 포함되는 개발 관련 공모전을 준비하거나 참여한다.
	8. 동아리에 기술적으로 기여 후, 학기 말까지 이에 대한 보고서 제출
...
3. 아래의 각 호중 적어도 한 가지 경우에 해당하는 회원은 제1항을 만족하지 아니하여도 회원자격을 유지할 수 있다.
	...
	3. 해당 학기에 임원진으로 활동하는 경우
	4. 개인의 사유가 제2호에 해당하는지는 회장단 회의를 통해 결정한다.
